...
[![codecov](https://codecov.io/gh/docwyatt2001/EventBus2/branch/main/graph/badge.svg?token=413FQZ5QQA)](https://codecov.io/gh/docwyatt2001/EventBus2)
![Build Status](https://github.com/docwyatt2001/EventBus2/actions/workflows/test.yml/badge.svg)
...
Type the following command in your terminal:
	...
	go get github.com/docwyatt2001/EventBus2
...
```go
import "github.com/docwyatt2001/EventBus2"
```
If you unhappy to use long `EventBus`, you can do something like this:
```go
import (
	evbus "github.com/docwyatt2001/EventBus2"
)
```
...
#### Notes
Documentation is available here: [godoc.org](https://godoc.org/github.com/docwyatt2001/EventBus2).
Full information about code coverage is also available here: [EventBus on gocover.io](http://gocover.io/github.com/docwyatt2001/EventBus2) or [EventBus on codecov.io](https://app.codecov.io/gh/docwyatt2001/EventBus2)

#### Support
If you do have a contribution for the package feel free to put up a Pull Request or open Issue.

#### Special thanks to [contributors](https://github.com/docwyatt2001/EventBus2/graphs/contributors)
...
* [Malcolm White] (https://github.com/docwyatt2001)
